...
* [Google Group - Meteor Brasil](https://groups.google.com/forum/#!forum/meteor-brasil)
...
* [MeteorHelp](http://meteorhelp.com/)
...
* [Meteor Create](http://meteorcreate.com/)
...
* [MeteorJS Jobs](https://twitter.com/meteorjobs)
...
* [Underground WebDev - Meteor](http://udgwebdev.com/meteor/)
...
* [Introdução sobre Meteor](http://udgwebdev.com/introducao-sobre-meteor)
* [Dynamic Template Includes With Blaze](https://www.discovermeteor.com/blog/blaze-dynamic-template-includes/)
* [How Blaze Works - Meteor's Reactive Templating UI](http://meteorhacks.com/how-blaze-works.html)
...
* [Building large, modular apps in Meteor](http://tech.exponential.io/meteor/building-large-modular-apps-meteor/)
* [Using Node Modules with Meteor](https://davidbeath.com/posts/using-node-modules-with-meteor.html)
* [Getting Started With Unipackage](https://meteor.hackpad.com/Getting-Started-With-Unipackage-IOckQBQgXaQ)
* [Meteor.js Package Only App Structure With Mediator Pattern](http://www.manuel-schoebel.com/blog/meteorjs-package-only-app-structure-with-mediator-pattern)
* [Meteor project structure — the way forward](http://www.matb33.me/2013/09/05/meteor-project-structure.html)
...
* [Scaling Meteor](http://fightingtheboss.github.io/scaling_meteor.html)
* [Meteor, the Oplog and Elastic Deployments](http://blog.mongohq.com/meteor-the-oplog-and-elastic-deployment/)
* [Testing Tools Comparison](http://safety-harness.meteor.com/comparison)
* [Meteor & Security: Setting the Record Straight](https://www.discovermeteor.com/blog/meteor-and-security/)
* [Lookback: Confessions of a startup: all our numbers, insights, everything](https://lookback.io/blog/confessions-of-a-startup)
...
* [Building a Production-Ready Meteor App](http://www.slideshare.net/RitikM/building-a-production-ready-meteor-app)
* [Building large scale Meteor apps](http://meteor.redandivory.com/#/)
...
* [Understanding Deps](https://meteor.hackpad.com/DRAFT-Understanding-Deps-aAXG6T9lkf6)
* [Meteor : la plateforme Web temps réel qui accroît la productivité](http://soren-ohnmeiss.developpez.com/tutoriels/javascript/meteor/introduction-meteor/)
* [Meteor PubSub](http://udgwebdev.com/meteor-pubsub/)
* [Organizando um projeto Meteor](http://udgwebdev.com/organizando-um-projeto-meteor)
* [Meteor Methods](http://udgwebdev.com/meteor-methods/)
* [How To Add a Twitter Login System to Your Meteor Application with Smart Packages](http://meteortips.com/twitter-account-login-system-tutorial/)
* [Reactive Forms in Meteor JS](http://www.neo.com/2014/05/23/reactive-forms-in-meteor-js)
* [meteor: check a user's password](https://dweldon.silvrback.com/check-password)
...
* [Meteor #1: Deploy a Meteor application on Ubuntu with Nginx](http://journal.gentlenode.com/meteor-1-deploy-a-meteor-application-on-ubuntu-with-nginx/)
* [Meteor #2: Build a complete registration system](http://journal.gentlenode.com/meteor-2-build-a-complete-registration-system/)
* [Meteor #3: SMTP configuration](http://journal.gentlenode.com/meteor-3-smtp-configuration/)
...
* [Meteor #6: Reactive and non-reactive join with MongoDB](http://journal.gentlenode.com/meteor-6-reactive-and-nonreactive-join-with-mongodb/)
* [Meteor #7: Must-watch videos](http://journal.gentlenode.com/meteor-7-must-watch-videos/)
* [Meteor #8: Create and execute a payment with Paypal REST API](http://journal.gentlenode.com/meteor-8-create-and-execute-a-payment-with-paypal-rest-api/)
* [Meteor #9: Internationalization (i18n)](http://journal.gentlenode.com/meteor-9-internationalization-i18n/)
* [Meteor #10: Set up Oplog tailing on Ubuntu](http://journal.gentlenode.com/meteor-10-set-up-oplog-tailing-on-ubuntu/)
* [Meteor #11: Iron Router cheatsheet](http://journal.gentlenode.com/meteor-11-iron-router-cheatsheet/)
* [Meteor #12: The complete guide to SEO](http://journal.gentlenode.com/meteor-12-seo-guide/)
* [Meteor #13: Managing User Roles](http://journal.gentlenode.com/meteor-13-managing-user-roles/)
* [Running your meteor.js application on your own server](http://ox86.tumblr.com/post/45184656062/running-your-meteor-js-application-on-your-own-server)
...
* [Ground Control](https://github.com/percolatestudio/ground-control)
* [Browpie](https://github.com/alanshaw/meteor-browpie)
* [Fortnight](https://github.com/oliversong/fortnight)
* [Reaction](https://github.com/ongoworks/reaction)
* [Crowducate](https://github.com/Crowducate/crowducate.me)
* [Repeeet](https://github.com/meteorhacks/repeeet)
* [We Work Meteor](https://github.com/nate-strauser/wework)
* [Lister](https://github.com/Differential/lister)
* [Supporter](https://github.com/Differential/supporter)
* [Kvazar](https://github.com/AristosGroup/kvazar)
* [Broadast](https://github.com/seanrose/broadcast)
* [Itinerary](https://github.com/tomsabin/itinerary)
* [Socialite](https://github.com/eprochasson/socialite)
* [TicTacToe](https://github.com/caio-ribeiro-pereira/meteor-tictactoe)
* [Faraona](https://github.com/Fenicio/Faraona)
* [Meteoritter](https://github.com/Fenicio/Meteoritter)
* [Padawan](https://github.com/Fenicio/padawan)
* [Microphone](https://github.com/Differential/microphone)
...
* [Blog](http://github.differential.io/meteor-blog/)
* [Accounts-Entry](http://github.differential.io/accounts-entry/)
* [Billing](http://github.differential.io/meteor-billing/)
* [Profile](https://github.com/Differential/meteor-profile)
* [Voltage](http://github.differential.io/meteor-voltage/)
...
* [Orion, a CMS for Meteor](http://orionjs.org/)
...
* [Meteor Cucumber](https://github.com/xdissent/meteor-cucumber)
